========================================================================
    APLICACIÓN: Información general del proyecto 2do_ProyectoDatos
========================================================================

AppWizard ha creado esta aplicación 2do_ProyectoDatos.  

Este archivo incluye un resumen acerca del contenido de los archivos que
constituyen su aplicación 2do_ProyectoDatos.

2do_ProyectoDatos.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado 2do_ProyectoDatos.pch y un archivo de 
